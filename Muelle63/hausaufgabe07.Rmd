...
Die rote Verteilung sieht am fairsten aus.Die Kurve sieht normalverteilt aus und erfasst im Mittelfeld eine große Menge der Studenten (Fläche unter der Kurve). 
...
Der kritische Wert für einen einseitigen $z$-Test ist `r qnorm(0.95)`.

Die kritischen Werte für einen zweiseitigen $z$-Test sind $\pm$`r qnorm(0.975)`.
