...
# Nein, es gibt nicht immer nur einen Modalwert. Es kann mehrere geben (Z.B. gleich viele Männer und Frauen) und der code zeigt dann alle Werte an, die am häufigsten auftreten.Der Code wäre dann auch korrekt.

# Zum Abschied ein Beispiel mit der Darstellung Frequenzdaten mit Säulendiagramm
# bzw. Histogramm
