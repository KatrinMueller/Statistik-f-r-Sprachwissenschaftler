...
dat <- read.table("Muelle63//body_dim_long.tab",header=TRUE) 
...
# Wenn wir verschiedene Grafiken mit einem Datensatz machen möchten, ist es
...
# dadurch unsere Ergebnisse verstellt? Sie müssen hier nichts schreiben, aber 
...
# (Keine explizite Antwort nötig, nur eine Überlegung.)
# Es haben 2 Gruppen gefehlt, nämlich M.A. Germanistische Linguistik und other.
# M.A. Germanistische Linguistik hat nur einen Datenpunkt und other 2.
# Deshalb ist keine Darstellung der Dichteverteilung möglich.
